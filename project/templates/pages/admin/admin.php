...
View::includeTemplate('layouts/header.php', ['title' => 'Административный раздел', 'pageTitle' => 'QSOFT учебный сайт - Административный раздел', 'currentPage' => 'admin']);
?>
...
<table class="border border-collapse w-full">
    ...
    <?php View::includeTemplate('blocks/admin/main_table.php', ['cars' => $cars]) ?>
</table>
